...
const LoginForm: React.FC<LoginFormProps> = ({ onLogin, onSwitchToSignup, onForgotPassword, className }) => {
      ...
      >
        ...
        <div className="px-8 py-8 text-center border-b border-primary-200/30 bg-gradient-to-r from-primary-600 to-primary-700 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-primary-100 text-sm">Sign in to your account</p>
          </div>
        </div>
